package model.configs.ticketBD;

import model.configs.constBD.Const;

public class ConstTicket extends Const {
    ...
    public static final String TICKET_TRANSPORT_TYPE = "transportType";

    public static final String TICKET_DEPARTURE_POINT = "departurePoint";
